...
is( $engine->from_into(), 'ca-es',
    'Current language pair should be Catalan -> Spanish' );
...
is( $engine->from_into(), 'fr-es',
    'Current language pair should be French -> Spanish' );

$engine->from_into( 'es-fr' );
is( $engine->from_into(), 'es-fr',
    'Current language pair should be Spanish -> French' );

$engine->from_into( 'ca-eo' );
is( $engine->from_into(), 'ca-eo',
    'Current language pair should be Catalan -> Esperanto' );

$engine->from_into( 'es-eo' );
is( $engine->from_into(), 'es-eo',
    'Current language pair should be Spanish -> Esperanto' );

$engine->from_into( 'ro-es' );
is( $engine->from_into(), 'ro-es',
    'Current language pair should be Romanian -> Spanish' );

$engine->from_into( 'es-en' );
is( $engine->from_into(), 'es-en',
    'Current language pair should be Spanish -> English' );

$engine->from_into( 'en-es' );
is( $engine->from_into(), 'en-es',
    'Current language pair should be English -> Spanish' );

$engine->from_into( 'cy-en' );
is( $engine->from_into(), 'cy-en',
    'Current language pair should be Welsh -> English' );

$engine->from_into( 'eu-es' );
is( $engine->from_into(), 'eu-es',
    'Current language pair should be Basque -> Spanish' );

$engine->from_into( 'en-gl' );
is( $engine->from_into(), 'en-gl',
    'Current language pair should be English -> Galician' );

$engine->from_into( 'gl-en' );
is( $engine->from_into(), 'gl-en',
    'Current language pair should be Galician -> English' );
